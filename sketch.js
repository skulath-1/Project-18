...
var gameOverSound ,knifeSwoosh, virusSound;
...
function preload(){
  ...
  virusImage= loadImage("virus-5468274_1280.png")
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if(virusGroup.isTouching(knife)){
      gameState=END;
      //gameover sound
      gameOverSound.play()
...
function virus(){
  if(World.frameCount%200===0){
    ...
    virus.addAnimation("moving1", virusImage);
    virus.y=Math.round(random(100,550));
